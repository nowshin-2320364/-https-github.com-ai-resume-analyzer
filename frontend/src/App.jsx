...
const styles = {
  container: { minHeight: '100vh', backgroundColor: '#090d16', color: '#f3f4f6', padding: '2rem 1rem', fontFamily: 'Inter, system-ui, -apple-system, sans-serif', maxWidth: '1100px', margin: '0 auto' },
  ...
  dropzone: { border: '2px dashed #374151', borderRadius: '8px', padding: '2rem', textAlign: 'center', cursor: 'pointer', transition: 'all 0.2s ease' },
  ...
  textarea: { backgroundColor: '#0f172a', border: '1px solid #334155', borderRadius: '6px', color: '#fff', padding: '0.75rem', fontSize: '0.95rem', outline: 'none', fontFamily: 'inherit' },
  button: { backgroundColor: '#2563eb', color: '#fff', fontWeight: '700', padding: '0.85rem', border: 'none', borderRadius: '6px', cursor: 'pointer', fontSize: '1rem' },
